...
- `plot_weather.py` — generates the 5 plots above into `images/`.
...
Week 1 — local environment, data pipeline, 5 plots done. Next: pull occupancy data (IDFM), start building the thermal model layer.